...
import com.jun.service.account.domain.redis.RedisReciever;
import com.jun.service.account.domain.redis.TopicConfig;
...
public class RedisConfig {
  ...
  ChannelTopic mailTopic() {
    return new ChannelTopic(TopicConfig.MAIL_TOPIC);
  }
